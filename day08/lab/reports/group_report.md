...
| Vũ Hồng Quang | Thiết kế `test_questions.json` (10 câu, expected answer, expected source); chạy pipeline với grading questions lúc 17:00; xuất `logs/grading_run.json` đúng định dạng trước 18:00. | Sprint 3, 4 |
